...
import 'package:devcops/models/sketch_to_image/setDrawingArea.dart';
...
class _SketchScreenState extends State<SketchScreen> {
  ...
  void retrieveResponse(var base64Image) async
  {
    ...
    //:5000/predict
    var urlFlaskServer = 'http://192.168.29.79:5000/predict';
    ...
    try {
      var response = await http.post(
          Uri.parse(urlFlaskServer), body: body, headers: headers);
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        IconButton(
                          icon: Icon(
                            Icons.cleaning_services_rounded, color: Colors
                              .white,),
                          onPressed: () {
                            this.setState(() {
                              allPoints.clear();
...
//6. flask run --host=Your IPv4 address
